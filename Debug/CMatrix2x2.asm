; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61030.0 
	...
	TITLE	C:\Users\Simon\Documents\Visual Studio 2012\Projects\Stereoscopic\Import\Math\CMatrix2x2.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0FJ@DMPEBKOI@c?3?2users?2simon?2documents?2visual?5@ ; `string'
...
PUBLIC	??_C@_0FN@HNEPGBID@c?3?2users?2simon?2documents?2visual?5@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0FN@HNEPGBID@c?3?2users?2simon?2documents?2visual?5@
CONST	SEGMENT
??_C@_0FN@HNEPGBID@c?3?2users?2simon?2documents?2visual?5@ DB 'c:\users\s'
...
CONST	ENDS
;	COMDAT ??_C@_0FJ@DMPEBKOI@c?3?2users?2simon?2documents?2visual?5@
CONST	SEGMENT
??_C@_0FJ@DMPEBKOI@c?3?2users?2simon?2documents?2visual?5@ DB 'c:\users\s'
	DB	'imon\documents\visual studio 2012\projects\stereoscopic\impor'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\visual studio 2012\projects\stereoscopic\import\math\cmatrix2x2.cpp
...
; 607  : 	GEN_ASSERT( !IsZero(det), "Singular matrix" );
	...
	add	eax, 7
	push	eax
	push	OFFSET ??_C@_0FN@HNEPGBID@c?3?2users?2simon?2documents?2visual?5@
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\visual studio 2012\projects\stereoscopic\import\math\cmatrix2x2.h
...
; 56   : 		GEN_ASSERT_OPT( pfElts, "Invalid parameter" );
	...
	push	56					; 00000038H
	push	OFFSET ??_C@_0FJ@DMPEBKOI@c?3?2users?2simon?2documents?2visual?5@
	push	OFFSET ??_C@_0BC@DBAKKFEN@Invalid?5parameter?$AA@
	lea	ecx, DWORD PTR $T2[ebp]
	call	??0CFatalException@gen@@QAE@PBD0H@Z	; gen::CFatalException::CFatalException
	push	OFFSET __TI1?AVCFatalException@gen@@
