; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61030.0 
	...
	TITLE	C:\Users\Simon\Documents\Visual Studio 2012\Projects\Stereoscopic\Import\Math\BaseMath.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0FL@PCGNHBEH@c?3?2users?2simon?2documents?2visual?5@ ; `string'
...
??_C@_0BI@PFDDEJKP@Invalid?5rounding?5method?$AA@ DB 'Invalid rounding me'
	DB	'thod', 00H					; `string'
CONST	ENDS
;	COMDAT ??_C@_0FL@PCGNHBEH@c?3?2users?2simon?2documents?2visual?5@
CONST	SEGMENT
??_C@_0FL@PCGNHBEH@c?3?2users?2simon?2documents?2visual?5@ DB 'c:\users\s'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\visual studio 2012\projects\stereoscopic\import\math\basemath.cpp
...
; 338  : 				GEN_ERROR( "Invalid rounding method" );
	...
	push	eax
	push	OFFSET ??_C@_0FL@PCGNHBEH@c?3?2users?2simon?2documents?2visual?5@
